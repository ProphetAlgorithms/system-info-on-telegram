...
if [ ${ENABLE_VALIDATOR_INFO} = "yes" ]; then
  ...
  # Local Tendermint RPC:
  # NODE_FLAG=" --node tcp://localhost:26657"
  # Remote Tendermint RPC:
  # NODE_FLAG=" --node <remote Tendermint RPC address>"
  # If the Tendermint RPC address has been specified in any configuration file:
  NODE_FLAG=""
